...
from src.backend.infrastructure.db.companies.model import CompanyModel
from src.backend.infrastructure.db.users.model import UserModel
from src.backend.main.config import config as app_config
...
sqlalchemy_url: str = app_config.postgresql.connection_url
